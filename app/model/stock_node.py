...
class StockValue:
    ...
    def getOHLCAverage(self):
        '''
            Determine the OHLC average and return this
...
class StockProfit:
    ...
    @profitPreNoneCheck
    def getPercentageGain(self):
        '''
            Returns the percentage gain between buy and sell

            Returns:
                (float)
        '''
        return round((self.sell.getOHLCAverage() - self.buy.getOHLCAverage()) /
                     self.buy.getOHLCAverage() * 100, 4)
